...
# @mediafile @update
# Scenario Outline: Update mediafile when collection_id (in body) not found
#     # update mediafile
# Given set request header token from global param 'editor_token' 
#   And set request path param 'collection_id' from global param 'collection_id'
#   And set request path param 'mediafile_id' from global param 'mediafile_id'
#   And set request body param 'collection_id' from value '<collection_id>'
#   And set request body param 'original_filename' from fake 'original_filename'
#   And set request body param 'mediafile_summary' from fake 'mediafile_summary'
#   And set request body param 'tags' from fake 'mediafile_tags'
#  When send 'PUT' request to url 'collection/:collection_id/mediafile/:mediafile_id'
#  Then response code is '404'
...
# @mediafile @update
# Scenario Outline: Update mediafile when collection_id (in body) is invalid
#     # update mediafile
# Given set request header token from global param 'editor_token' 
#   And set request path param 'collection_id' from global param 'collection_id'
#   And set request path param 'mediafile_id' from global param 'mediafile_id'
...
# @mediafile @update
# Scenario: Update mediafile when collection (in body) is locked
#     # lock collection
# Given set request header token from global param 'admin_token' 
#   And set request path param 'collection_id' from global param 'collection_id'
