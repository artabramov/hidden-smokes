...
Background: Auth users, upload a datafile, download revision
    # auth users
...
Given set request header token from global param 'admin_token'
 ...
 When send 'GET' request to url 'datafile/:datafile_id/download/:download_id'
...
@download @select
Scenario Outline: Select download when datafile_id is incorrect
    # list downloads
Given set request header token from global param 'admin_token'
  And set request path param 'datafile_id' from global param 'datafile_id' 
 ...
 When send 'GET' request to url 'datafile/:datafile_id/downloads'
 Then response code is '200'
...
Given set request header token from global param 'editor_token'
  And set request path param 'mdiafile_id' from global param 'datafile_id'
