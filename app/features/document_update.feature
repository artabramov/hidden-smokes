...
# @document @update
# Scenario Outline: Update document when collection_id (in body) not found
#     # update document
# Given set request header token from global param 'editor_token' 
...
#   And set request body param 'document_summary' from fake 'document_summary'
#   And set request body param 'tags' from fake 'document_tags'
#  When send 'PUT' request to url 'collection/:collection_id/document/:document_id'
#  Then response code is '404'
...
# @document @update
# Scenario Outline: Update document when collection_id (in body) is invalid
#     # update document
# Given set request header token from global param 'editor_token' 
#   And set request path param 'collection_id' from global param 'collection_id'
#   And set request path param 'document_id' from global param 'document_id'
...
# @document @update
# Scenario: Update document when collection (in body) is locked
#     # lock collection
# Given set request header token from global param 'admin_token' 
#   And set request path param 'collection_id' from global param 'collection_id'
