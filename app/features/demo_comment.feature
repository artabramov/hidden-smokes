...
Given set request header token from global param 'admin_token' 
 ...
 Then response code is '200'
  ...
  And save id from response list 'datafiles' to global param 'datafile_id'
    # insert datafile
Given set request header token from global param 'admin_token' 
  And set request param 'datafile_id' from global param 'datafile_id'
