...
Given set request body param 'user_login' from value '<user_login>'
  ...
  And set request body param 'user_capture' from fake 'user_capture'
...
@user @register
Scenario Outline: Register user when user_capture is invalid
    # register user
Given set request body param 'user_login' from fake 'user_login'
  And set request body param 'user_password' from value '123456'
  And set request body param 'first_name' from fake 'first_name'
  And set request body param 'last_name' from fake 'last_name'
  And set request body param 'user_capture' from value '<user_capture>'
  And set request body param 'user_contacts' from fake 'user_contacts'
 When send 'POST' request to url 'user'
 Then response code is '422'
  And error loc is 'body' and 'user_capture'
  And error type is '<error_type>'
  And response contains '1' params

Examples:
| user_capture | error_type      |
| string(41)     | string_too_long |

@user @register
Scenario Outline: Register user when user_capture is correct
    # register user
Given set request body param 'user_login' from fake 'user_login'
  And set request body param 'user_password' from value '123456'
  And set request body param 'first_name' from fake 'first_name'
...
@user @register
Scenario: Register user when lock mode is enabled
Given auth with user role 'admin'
    # enable lock mode
Given set request header token from global param 'admin_token'
