...
@datafile @delete
Scenario: Delete datafile when datafile_id not found
    # delete datafile
Given set request header token from global param 'admin_token'
  And set request path param 'datafile_id' from value '9999999999'
...
@datafile @delete
Scenario: Delete datafile when collection is locked
    # lock collection
Given set request header token from global param 'admin_token' 
  And set request path param 'collection_id' from global param 'collection_id'
...
@datafile @delete
Scenario: Delete datafile when app is locked
    # create lock
Given set request header token from global param 'admin_token' 
...
@datafile @delete
Scenario: Delete datafile when user is admin
    # delete datafile
Given set request header token from global param 'admin_token' 
  And set request path param 'datafile_id' from global param 'datafile_id'
 When send 'DELETE' request to url 'datafile/:datafile_id'
...
@datafile @delete
Scenario: Delete datafile when user is editor
    # delete datafile
...
@datafile @delete
Scenario: Delete datafile when user is writer
    # delete datafile
...
@datafile @delete
Scenario: Delete datafile when user is reader
    # delete datafile
...
@datafile @delete
Scenario: Delete datafile when token is missing
    # delete datafile
