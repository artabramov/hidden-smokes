...
@collection @list
Scenario Outline: List collections when datafiles_count__ge is invalid
    # list collections
Given set request header token from global param 'reader_token' 
  And set request query param 'datafiles_count__ge' from value '<datafiles_count>'
  And set request query param 'offset' from value '0'
  And set request query param 'limit' from value '1'
  And set request query param 'order_by' from value 'id'
  And set request query param 'order' from value 'asc'
 When send 'GET' request to url 'collections'
 Then response code is '422'
  And error loc is 'query' and 'datafiles_count__ge'
  And error type is '<error_type>'
  And response contains '1' params

Examples:
| datafiles_count | error_type  |
| tabs            | int_parsing |
| spaces          | int_parsing |
| 123.4           | int_parsing |
| 123,0           | int_parsing |
...
@collection @list
Scenario Outline: List collections when datafiles_count__ge is correct
    # list collections
Given set request header token from global param 'reader_token' 
  And set request query param 'datafiles_count__ge' from value '<datafiles_count>'
  And set request query param 'offset' from value '0'
...
@collection @list
Scenario Outline: List collections when datafiles_count__le is invalid
    # list collections
Given set request header token from global param 'reader_token' 
  And set request query param 'datafiles_count__le' from value '<datafiles_count>'
  And set request query param 'offset' from value '0'
  And set request query param 'limit' from value '1'
  And set request query param 'order_by' from value 'id'
  And set request query param 'order' from value 'asc'
 When send 'GET' request to url 'collections'
 Then response code is '422'
  And error loc is 'query' and 'datafiles_count__le'
  And error type is '<error_type>'
  And response contains '1' params
...
@collection @list
Scenario Outline: List collections when datafiles_count__le is correct
    # list collections
Given set request header token from global param 'reader_token' 
  And set request query param 'datafiles_count__le' from value '<datafiles_count>'
  And set request query param 'offset' from value '0'
